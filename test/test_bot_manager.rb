...
class TestBotManager < Minitest::Test
  ...
  def test_init
    ...
    assert_equal(@bot_manager.bot_list[2]["Name"], "eurocup_2016")
    assert_equal(@bot_manager.bot_list[3]["Name"], "iciba")
    assert_equal(@bot_manager.bot_list[4]["Name"], "aqi")
    assert_equal(@bot_manager.bot_list[5]["Name"], "hello_world")
